...
//
// File:        raddinputcodes.hpp
//
// Description: The input layer identifies keys, axes and buttons by their
//              DirectInput code: keyboard scancodes (DIK_*) and byte offsets
//              into the DIJOYSTATE / DIMOUSESTATE2 structures (DIJOFS_* /
//              DIMOFS_*). Those codes are only a numbering scheme, so
//              platforms without DirectInput reuse them and have their
//              controller backend report the same values.
//
//              These values must stay identical to dinput.h: saved controller
//              configs store them verbatim.
//
//=============================================================================

#ifndef RADDINPUTCODES_HPP
#define RADDINPUTCODES_HPP
...
//=============================================================================
// Keyboard scancodes (PC scancode set 1).
//=============================================================================
...
// Aliases dinput.h also provides.
...
//=============================================================================
// Byte offsets into DIMOUSESTATE2:
//   LONG lX, lY, lZ; BYTE rgbButtons[8];
//=============================================================================
